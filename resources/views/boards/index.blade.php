            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Boards Page</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
...
{{--                        <th style="width: 100px">Role</th>--}}
                    ...
                    @foreach ($boards as $board)
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <button class="btn btn-xs btn-primary" type="button" data-user="" data-toggle="modal" data-target="#edit-modal">
                                        <i class="fas fa-edit"></i></button>
                                    <button class="btn btn-xs btn-danger" type="button" data-user="" data-toggle="modal" data-target="#delete-modal">
